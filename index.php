...
<body>
    ...
    <header>
        ...
        <div class="middle">
            ...
            <h2>Rejoignez les 100 millions de membres du Social Club dans le monde sur la plateforme 
            officielle de Rockstar Games pour améliorer et étendre votre expérience de jeu.</h2>
                <div class="boutonmiddle">
                    <div id="btc" ><a  href="https://localhost/module-connexion/connexion.php">Se connecter</div></a>
                    <div id="bti" ><a  href="http://localhost/module-connexion/inscription.php/">Inscription</div></a>
                </div>
        </div>
